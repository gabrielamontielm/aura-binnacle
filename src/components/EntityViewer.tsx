...
export const EntityViewer: React.FC<EntityViewerProps> = ({ details, relatedArtworks, onArtworkClick, onBack }) => {
  return (
    <motion.div 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="flex flex-col lg:flex-row h-full min-h-screen bg-artistic-bg w-full overflow-y-auto lg:overflow-hidden"
    >
      {/* Visual / Introduction Side */}
      <div className="w-full lg:w-1/2 p-10 lg:p-20 flex flex-col justify-center bg-white border-r border-artistic-ink/5 relative overflow-y-auto">
      ...
      {/* Analysis Side */}
      <div className="w-full lg:w-1/2 p-10 lg:p-20 flex flex-col justify-center bg-artistic-bg overflow-y-auto">
